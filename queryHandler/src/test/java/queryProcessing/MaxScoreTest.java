...
class MaxScoreTest extends MaxScore{
    ...
    public static Stream<Arguments> getParameters() {
        ...
        return Stream.of(Arguments.arguments("tfidf",3,"example",0.0),
    ...
    void testMaxScore(String scoringFunction,int k, String query,double score){
